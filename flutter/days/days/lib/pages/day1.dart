  ...
  void _handleRightBtn() {
    if (_stopwatch.isRunning) {
      ...
      Timer.periodic(Duration(milliseconds: 10), (interval) {
        ...
        seccountingTime = countingTime - _recordTime;secminute =(seccountingTime / (60 * 1000)).floor();
...
class WatchControl extends StatefulWidget {
  WatchControl({Key key, @required this.onRightBtn, @required this.onLeftBtn, this.watchOn}): super(key: key);
