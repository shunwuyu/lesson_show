...
const KEY = '9845f812279b4d019ef309aa8c5cd4f4'
const USER_ID = 'HE1811231213441959'

const WECHAT_APPID = 'HE1811231213441959'
const WECHAT_APP_SECRET = '9845f812279b4d019ef309aa8c5cd4f4'
const $ = {
  getWechatAppConfig: () => {
    return {
      id: WECHAT_APPID,
 ...
 */
  ...
  handlerData: (data) => {
    ...
    if (data && data.HeWeather6 && data.HeWeather6[0].now) {
      ...
      console.log(now, daily_forecast, lifestyle, hourly)
      return {
        status: 0,
