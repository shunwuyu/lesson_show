...
describe('BinaryTreeNode', () => {
  ...
  it('should replace child node', () => {
    ...
    // const replacementNode2 = new BinaryTreeNode(8);
    rightNode.setRight(replacementNode);
    // replacementNode.setRight(replacementNode2);
    ...
    // expect(rootNode.right.value).toBeNull();
  ...
  it('should calculate node height', () => {
    ...
    // expect(grandRight.height).toBe(1);
